...
require (
	...
	github.com/rancher/local-path-provisioner v0.0.31 // indirect
	...
	sigs.k8s.io/sig-storage-lib-external-provisioner/v10 v10.0.1 // indirect
...
replace (
	...
	k8s.io/cri-client => github.com/k3s-io/kubernetes/staging/src/k8s.io/cri-client v1.33.2-k3s1
	...
	k8s.io/legacy-cloud-providers => github.com/k3s-io/kubernetes/staging/src/k8s.io/legacy-cloud-providers v1.33.2-k3s1
