...
KUBESOLO_VERSION=v0.1.3-beta KUBESOLO_PATH=/opt/kubesolo sh install-minimal.sh
```
...
```bash
export KUBESOLO_VERSION="v0.1.3-beta"           # Version to install
...
wget https://github.com/portainer/kubesolo/releases/download/v0.1.3-beta/kubesolo-v0.1.3-beta-linux-arm64.tar.gz
