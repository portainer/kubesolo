...
KUBESOLO_VERSION=v1.1.9 KUBESOLO_PATH=/opt/kubesolo sh install-minimal.sh
```
...
```bash
export KUBESOLO_VERSION="v1.1.9"           # Version to install
...
wget https://github.com/portainer/kubesolo/releases/download/v1.1.9/kubesolo-v1.1.9-linux-arm64.tar.gz
